...
// dist/libadlmidi.nuked.browser.js
async function createADLMIDI(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("libadlmidi.nuked.browser.wasm");
    }
    return new URL("libadlmidi.nuked.browser.wasm", import.meta.url).href;
  }
...
var libadlmidi_nuked_browser_default = createADLMIDI;
...
var _AdlMidiProcessor = class _AdlMidiProcessor extends AudioWorkletProcessor {
  ...
  async initWasm(processorOptions) {
    try {
      ...
      const Module = await libadlmidi_nuked_browser_default(moduleConfig);
      this.adl = Module;
