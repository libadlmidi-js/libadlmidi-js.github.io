...
// dist/libadlmidi.dosbox.browser.js
async function createADLMIDI(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("libadlmidi.dosbox.browser.wasm");
    }
    return new URL("libadlmidi.dosbox.browser.wasm", import.meta.url).href;
  }
...
var libadlmidi_dosbox_browser_default = createADLMIDI;
...
var _AdlMidiProcessor = class _AdlMidiProcessor extends AudioWorkletProcessor {
  ...
  async initWasm(processorOptions) {
    try {
      ...
      const Module = await libadlmidi_dosbox_browser_default(moduleConfig);
      this.adl = Module;
