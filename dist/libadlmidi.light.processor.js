...
// dist/libadlmidi.light.browser.js
async function createADLMIDI(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("libadlmidi.light.browser.wasm");
    }
    return new URL("libadlmidi.light.browser.wasm", import.meta.url).href;
  }
...
var libadlmidi_light_browser_default = createADLMIDI;
...
var _AdlMidiProcessor = class _AdlMidiProcessor extends AudioWorkletProcessor {
  ...
  async initWasm(processorOptions) {
    try {
      ...
      const Module = await libadlmidi_light_browser_default(moduleConfig);
      this.adl = Module;
